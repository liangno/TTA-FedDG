...
from data.digit_dataset import PACS_FedDG
...
def get_argparse():
    ...
    parser.add_argument("--test_domain", type=str, default='m',
                        choices=['m', 'mm', 'syn', 'svhn','usps'], help='the domain name for testing')
    parser.add_argument('--num_classes', help='number of classes default 7', type=int, default=10)
...
def main():
    ...
    for i in range(args.comm+1):
        ...
        print(dataloader_dict[args.test_domain]['test'])
